...
/**
 * Factory that creates {@link HyperscaleDbClient} instances by discovering
...
public final class HyperscaleDbClientFactory {
    ...
    /**
     * Create a {@link HyperscaleDbClient} from configuration.
     ...
     * @return a fully configured {@link HyperscaleDbClient}
    ...
    public static HyperscaleDbClient create(HyperscaleDbClientConfig config) {
        ...
        ServiceLoader<HyperscaleDbProviderAdapter> loader =
                ServiceLoader.load(HyperscaleDbProviderAdapter.class);
